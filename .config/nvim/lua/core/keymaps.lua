...
nvmap("<leader>cl", "<Cmd>CodeCompanionChat /lsp<CR>", "Code Companion - Explain LSP diagnostic")
vmap("<leader>ce", "<Cmd>CodeCompanionChat /explain<CR>", "Code Companion - Explain code")
vmap("<leader>cf", "<Cmd>CodeCompanionChat /fix<CR><Esc>", "Code Companion - Fix code")
vmap("<leader>cR", "<Cmd>CodeCompanionChat /chat-review<CR>", "Code Companion - Review code")
vmap("<leader>cn", "<Cmd>CodeCompanionChat /chat-naming<CR>", "Code Companion - Better naming")
